...
def about(update, context):
    ...
    message_1 = """Thank you for using Stonk Bot. Here are the key features:
        ...
        \n\u2022 Technical Analysis: use various popular TA tools and graphs to help in your decision making
        """
    message_2 = """Autonomous features (available only if you have a watchlist):
        \n\u2022 Daily Summary: provides the closing price and 1-day price change for a US-listed stock at the end of day (at 4am SGT) (and maybe some snark remarks)
        \n\u2022 Notification: provides an alert on significant TA-based changes for a US-listed stock. E.g. if the stock is overbought or oversold based on the RSI (at 12am and 4am SGT). Intra-day (5-min interval) RSI notification is also now available
        """
